...
import com.scp.database.DataBase;
...
public class DBTest{
	...
	public void insertDBdata() throws ClassNotFoundException, SQLException{
		String query = "insert into registration values('2','joker','town')";
		DataBase dataBase = new DataBase();
	...
	public void updateDBdata() throws ClassNotFoundException, SQLException{
		String query = "update registration set name='007007' where profession='town'";
		DataBase dataBase = new DataBase();
