...
import com.scp.helper.DropDown.DropDownHelper;
import com.scp.helper.Javascript.JavaScriptHelper;
...
public class ProductCategoryPage {
	...
	public ProductCategoryPage(WebDriver driver) {
		...
		waitHelper.waitForElement(driver, catalogTextObj,new Config(TestBase.PS).getExplicitWait());
	}
