...
import com.scp.excelReader.Excel_reader;
...
public class TestBase {
	...
	static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "/src/main/java/com/scp/report/test" + formater.format(calendar.getTime()) + ".html", false);
	}
	...
	public void loadPropertiesFile() throws IOException{
		...
		PS = new Properties();
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/scp/config/config.properties");
		file = new FileInputStream(f1);
		PS.load(file);
		logger.info("loading config.properties");
		
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/scp/properties/homepage.properties");
		file = new FileInputStream(f1);
		PS.load(file);
	...
	public String getScreenShot(String imageName) throws IOException{
		...
		String imagelocation = System.getProperty("user.dir")+"/src/main/java/com/scp/screenshot/";
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
	...
	public WebElement getWebElement(String locator) throws Exception{
		return getLocator(PS.getProperty(locator));
	}
	
	public List<WebElement> getWebElements(String locator) throws Exception{
		return getLocators(PS.getProperty(locator));
	}
	
	public String[][] getData(String excelName, String sheetName){
		System.out.println(System.getProperty("user.dir"));
		String excellocation = System.getProperty("user.dir")+"/src/main/java/com/scp/data/"+excelName;
	...
	public static void updateResultupdateResult(int indexSI,  String screenShotLocation,String response) throws IOException {
		...
		String resultFile = userDirector + "/src/main/java/com/scp/screenshot/TestReport.html";
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(test.PS.getProperty("username"));
